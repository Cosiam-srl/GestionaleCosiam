...
namespace CosiamAPI.Data.Migrations
{
    ...
    [Migration("20210721082210_CorrezioneServizioFornitore")]
    partial class CorrezioneServizioFornitore
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CosiamAPI.Models.Prezziario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CosiamAPI.Models.ServizioCliente", b =>
                {
                    ...
                    b.Property<int>("IdBeniEServizi")
                        .HasColumnType("int");

                    b.Property<int?>("IdCliente")
                        .HasColumnType("int");

                    b.Property<float>("pricePerUm")
                        .HasColumnType("real");

                    b.HasKey("Id");

                    b.HasIndex("IdBeniEServizi");
            ...
            modelBuilder.Entity("CosiamAPI.Models.ServizioCliente", b =>
                {
                    b.HasOne("CosiamAPI.Models.Prezziario", "BeniEServizi")
                        .WithMany()
                        .HasForeignKey("IdBeniEServizi")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
