...
const themeColors = [$info, '#0fa5e0', $success, '#8de28d', $info];


@Component({
  selector: 'app-composizione-costi',
  templateUrl: './composizione-costi.component.html',
  styleUrls: ['./composizione-costi.component.scss']
})
export class ComposizioneCostiComponent implements OnInit {
  ...
  // candlestickChartOptions: Partial<ChartOptions>;
  // bubbleChartOptions: Partial<ChartOptions>;
  ...
  constructor() {
    this.donutChartOptions = {
      ...
      colors: ['#f02a0c', '#10f00c', '#e2ed0e', '#0e3bf0', '#9C27B0'],
      series: [4, 5, 40, 30, 21],
      labels: ['Manodopera', 'Noli', 'Subappalti', 'Forniture', 'Spese generali'],
      legend: {
        itemMargin: {
          horizontal: 2
        },
...
// }
    ...
    //       data: [3100, 4000, 2800, 5100, 4200, 1900, 11000]
    //     },
    //     {
    //       name: 'Ricavi previsti',
    //       data: [1109, 13200, 4200, 1200, 3400, 5200, 14100]
    //     },
    //     {
    //       name: 'Utile effettivo',
    //       data: [1100, 3200, 4500, 3200, 3400, 5200, 14100]
    //     },
    //     {
    //       name: 'Utile previsto',
    //       data: [900, 11200, 2200, 3000, 3400, 2200, 15100]
    //     }
    //   ],
    //   title: {
  ...
  //     series: [{
  //       name: 'Product1',
  //       data: this.generateDataBubbleChart(new Date('11 Feb 2017 GMT').getTime(), 20, {
  //         min: 10,
  //         max: 60
  //       })
  //     }, {
  ...
  //     series: [{
  //       name: 'Metric1',
  //       data: this.generateDataHeatMapChart(18, {
  //         min: 0,
  //         max: 90
  //       })
  //     }, {
  ...
  // generateDataBubbleChart(baseval, count, yrange) {
  //   var i = 0;
  ...
  // generateDataHeatMapChart(count, yrange) {
  //   var i = 0,
  //     series = [];
  //   while (i < count) {
